...
interface PaginationProps {
    ...
    total: number
    limit: number
    setSingleParam: (name: string, value: string) => void
}
...
const Pagination = ({
    ...
    const handlePrev = () =>
        setSingleParam('page', String(Math.max(page - 1, 1)))
    const handleNext = () =>
        setSingleParam('page', String(Math.min(page + 1, totalPages)))
            ...
            <div className={styles.pages}>
                {pages.map((p, index) => {
                    ...
                    return (
                        <MyButton
                            key={p}
                            onClick={() => setSingleParam('page', String(p))}
                            className={
                                p === page
